...
export function StaffContent({ locale }: { locale: string }) {
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <p className="text-muted-foreground">
          {locale === 'fa' ? 'شما دسترسی لازم برای مشاهده این صفحه را ندارید' : 'You do not have permission to view this page'}
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle>{locale === 'fa' ? 'فیلترها' : 'Filters'}</CardTitle>
        </CardHeader>
        <CardContent>
          <StaffFilters
