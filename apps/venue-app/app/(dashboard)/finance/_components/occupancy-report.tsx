...
export function OccupancyReport({ period }: OccupancyReportProps) {
  ...
  const mockData = {
    ...
    byDayOfWeek: [
      { dayOfWeek: 0, dayName: 'Saturday', occupancyRate: 72.3, bookings: 45 },
      { dayOfWeek: 1, dayName: 'Sunday', occupancyRate: 68.5, bookings: 42 },
      { dayOfWeek: 2, dayName: 'Monday', occupancyRate: 64.2, bookings: 38 },
      { dayOfWeek: 3, dayName: 'Tuesday', occupancyRate: 66.8, bookings: 40 },
      { dayOfWeek: 4, dayName: 'Wednesday', occupancyRate: 69.1, bookings: 43 },
      { dayOfWeek: 5, dayName: 'Thursday', occupancyRate: 75.6, bookings: 48 },
      { dayOfWeek: 6, dayName: 'Friday', occupancyRate: 58.3, bookings: 35 },
    ],
    heatmap: {
  ...
  return (
    <div className="space-y-6">
      ...
      />
      <OccupancyHeatmap data={mockData.heatmap.data} />
    </div>
  );
}
