...
export function ReportsContent() {
  ...
  const tabs = [
    ...
    { id: 'performance' as ReportTab, label: t('performance'), icon: TrendingUp },
  ];
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="mt-6">
        ...
        {activeTab === 'customers' && <CustomersReport period={period} />}
        {activeTab === 'performance' && <PerformanceReport period={period} />}
      </div>
    </div>
  );
}
